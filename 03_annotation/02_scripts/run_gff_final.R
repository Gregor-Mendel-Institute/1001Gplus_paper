...
# ---- Paths ----
path.lyrata = '/groups/nordborg/projects/the1001genomesplus/01_data/08_lyrata/pannagram_v10/intermediate/consensus/'

path.out = '/groups/nordborg/projects/the1001genomesplus/01_data/02_alignment/pannagram_v10_4/intermediate/'
...
file.ann.tair = '/groups/nordborg/projects/the1001genomesplus/01_data/09_tair10/TAIR10_GFF3_genes.gff'
...
# pokaz('* Get in Lyrata')
# 
# file.lyrata.res = paste0(path.annotation, 'lyrata_res.txt')

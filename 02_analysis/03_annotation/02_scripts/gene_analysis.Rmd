...
path.base = '../../../'
path.genes = paste(path.base, '01_data_common/02_annot_denovo/02_pannagram/genes_',s.version,'/', sep = '')
...
path.annot = paste(path.base, '01_data_common/02_annot_denovo/03_new_genes/', sep = '')

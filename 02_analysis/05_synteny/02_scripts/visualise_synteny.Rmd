...
for(i.chr in 1:n.chr){
  ...
  p = ggSynteny(idx.break, i.chr, accessions, i.order, 
                file.cen.pos=file.cen.pos, file.acc.len=file.acc.len, wnd.size = 1000000)
...
p.init = ggSynteny(idx.break, i.chr, accessions, i.order, wnd.size = 1000000)
p.init
